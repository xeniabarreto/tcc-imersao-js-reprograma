...
class HerbalMedicine extends Medicine {
  constructor(name, composition, batch, expiration, type, laboratory, value, qty) {
    ...
    this.constructor.herbalMedicineList.push({
      name: this.name,
  ...
  static herbalMedicineList = [];

  addMedicine(medicine, qty){
    if(medicine instanceof HerbalMedicine){
